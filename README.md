<div align="center">
  ...
  <p>
    ...
    <strong>반려동물 특화 일정 앱 포펫 (For Pet)</strong>
  </p>
</div>

## 프로젝트 개요

ForPet은 반려동물과 함께하는 일상 데이터를 기록하고 관리하는 앱입니다. <br/>
...
프로젝트는 Android 공식 앱 아키텍처 가이드를 참고해 구성했습니다.<br/>
UI는 Jetpack Compose로 구현했으며, ViewModel에서 StateFlow를 통해 화면 상태를 관리하고 Compose가 이를 구독해 UI를 갱신하도록 설계했습니다.
...
앱 진입점, 공통 계층, 기능 계층, 빌드 설정을 분리한 멀티 모듈 구조입니다.<br/>
...
빌드 설정은 `build-logic`의 convention plugin으로 공통화했습니다.<br/>
